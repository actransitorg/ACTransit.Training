...
using ACTransit.DataAccess.Maintenance.UnitOfWork;

namespace ACTransit.Training.Web.Business.Maintenance
{
    public abstract class MaintenanceServiceBase<T> : BaseService where T : class, new()
    {
        protected MaintenanceServiceBase()
        {
        }

        protected MaintenanceServiceBase(string currentUserName)
        {            
